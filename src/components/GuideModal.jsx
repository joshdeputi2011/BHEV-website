...
const steps = [
  {
    ...
    path: '/',
    icon: <FlashRegular />,
    heading: 'Understanding CHARGEGRID & UEI',
    description:
      'CHARGEGRID is India’s open, interoperable Unified EV Infrastructure framework. Just like UPI unified digital payments across banks, UEI unifies EV discovery, booking, and charging across all Charge Point Operators (CPOs).',
    highlights: [
          ...
          <div className="guide-modal__header">
            <div className="guide-modal__header-left">
              ...
              <h2 id="guide-modal-title" className="guide-modal__main-title">
                How to Navigate <span className="tiranga-gradient-text">CHARGEGRID</span>
              </h2>
            </div>
            <button
