...
// ── Minimal QR Code renderer (canvas-based, no external dep) ──
function drawQR(canvas, text, size = 200) {
  ...
  // Simple visual pattern from text hash (not a real QR — use a lib in production)
